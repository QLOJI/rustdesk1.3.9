...
- **[libs/hbb_common](https://github.com/QLOJI/hbb_common)**: video codec, config, tcp/udp wrapper, protobuf, fs functions for file transfer, and some other utility functions
